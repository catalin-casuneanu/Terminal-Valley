        ...
        talking: [
          ...
          },
          {
            events: [
              ...
              { type: "textMessage", text: "You crushed me like a junior.", faceHero: "npcA" },
    ...
    cutsceneSpaces: {
      ...
      [utils.asGridCoord(10, 6)]: [{
        ...
        events: [
          ...
          { type: "textMessage", text: "* You woke up in a kitchen that looks like a forrest *" },
          ...
          { type: "textMessage", text: "Ahem. What are you doing here?" },
          { type: "textMessage", text: "You don't look like a chef" },
          { type: "stand", who: "kitchenNpcA", direction: "right", time: 200 },
          ...
          { type: "textMessage", text: "* You should get away from here.*" },
    ...
    configObjects: {
      ...
      streetNpcA: {
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "All ambitious devs gather on Anchovy Avenue.", faceHero: "streetNpcA" },
            ]
          }
        ]
      },
      streetNpcB: {
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "I can't decide on my favorite programming language.", faceHero: "streetNpcB" },
            ]
          }
        ]
      },
    ...
    configObjects: {
      ...
      streetNorthNpcA: {
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "This place is famous for sending emails instead of having meetings!", faceHero: "streetNorthNpcA" },
            ]
          }
        ]
      },
      streetNorthNpcB: {
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "I love the fresh smell of coffee in the air.", faceHero: "streetNorthNpcB" },
            ]
          }
        ]
      },
